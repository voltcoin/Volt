...
#if defined(NDEBUG)
# error "VoltCoin cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAgeAdjusted = 60 * 60 * 1;  	// 1 Hour after block 10000
...
const string strMessageMagic = "VoltCoin Signed Message:\n";
